...
package local_project.testjob_copy_0_1;
...
/**
 * Job: TestJob_Copy Purpose: data flow in JSON<br>
 * Description: this is a test job for logging <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class TestJob_Copy implements TalendJob {
	...
	private final String jobName = "TestJob_Copy";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TestJob_Copy.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_TestJob_Copy = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_TestJob_Copy = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_TestJob_Copy.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_TestJob_Copy.length == 0) {
						commonByteArray_LOCAL_PROJECT_TestJob_Copy = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_TestJob_Copy = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_TestJob_Copy, 0,
						length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_TestJob_Copy, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_TestJob_Copy) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/ruchiagarwal3/Documents/Ruchi- Deloitte/CDP 2.0/talend/output.csv"))
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileOutputJSON_1 = new java.io.File(
						"C:/Users/ruchiagarwal3/Documents/Ruchi- Deloitte/CDP 2.0/talend/log.json");
					...
					for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
						...
						if (row2 != null) {
							...
							if (runTrace.isPause()) {
								...
								runTrace.sendTrace("row2", "tLogCatcher_1",
										runTraceData);
							}
						...
						if (row2.moment != null) {
							...
							jsonRowtFileOutputJSON_1.put("moment",
									FormatterUtils.format_Date(row2.moment,
											"yyyy-MM-dd HH:mm:ss"));

						} else {
							jsonRowtFileOutputJSON_1.put("moment", null);
						}

						if (row2.pid != null) {

							jsonRowtFileOutputJSON_1.put("pid", row2.pid);

						} else {
							jsonRowtFileOutputJSON_1.put("pid", null);
						}

						if (row2.root_pid != null) {

							jsonRowtFileOutputJSON_1.put("root_pid",
									row2.root_pid);

						} else {
							jsonRowtFileOutputJSON_1.put("root_pid", null);
						}

						if (row2.father_pid != null) {

							jsonRowtFileOutputJSON_1.put("father_pid",
									row2.father_pid);

						} else {
							jsonRowtFileOutputJSON_1.put("father_pid", null);
						}

						if (row2.project != null) {

							jsonRowtFileOutputJSON_1.put("project",
									row2.project);

						} else {
							jsonRowtFileOutputJSON_1.put("project", null);
						}

						if (row2.job != null) {

							jsonRowtFileOutputJSON_1.put("job", row2.job);

						} else {
							jsonRowtFileOutputJSON_1.put("job", null);
						}

						if (row2.context != null) {

							jsonRowtFileOutputJSON_1.put("context",
									row2.context);

						} else {
							jsonRowtFileOutputJSON_1.put("context", null);
						}

						if (row2.priority != null) {

							jsonRowtFileOutputJSON_1.put("priority",
									row2.priority);

						} else {
							jsonRowtFileOutputJSON_1.put("priority", null);
						}

						if (row2.type != null) {

							jsonRowtFileOutputJSON_1.put("type", row2.type);

						} else {
							jsonRowtFileOutputJSON_1.put("type", null);
						}

						if (row2.origin != null) {

							jsonRowtFileOutputJSON_1.put("origin", row2.origin);

						} else {
							jsonRowtFileOutputJSON_1.put("origin", null);
						}

						if (row2.message != null) {

							jsonRowtFileOutputJSON_1.put("message",
									row2.message);

						} else {
							jsonRowtFileOutputJSON_1.put("message", null);
						}

						if (row2.code != null) {

							jsonRowtFileOutputJSON_1.put("code", row2.code);

						} else {
							jsonRowtFileOutputJSON_1.put("code", null);
						}
	...
	public void tStatCatcher_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tStatCatcher_1",
						Boolean.FALSE);
				...
				String fileName_tFileOutputExcel_2 = "C:/Users/ruchiagarwal3/Documents/Ruchi- Deloitte/CDP 2.0/talend/statCatcher.xls";
				...
				int[] fitWidth_tFileOutputExcel_2 = new int[14];
				for (int i_tFileOutputExcel_2 = 0; i_tFileOutputExcel_2 < 14; i_tFileOutputExcel_2++) {
				...
				final jxl.write.WritableCellFormat cell_format_moment_tFileOutputExcel_2 = new jxl.write.WritableCellFormat(
				...
				for (StatCatcherUtils.StatCatcherMessage scm : tStatCatcher_1
					...
					if (row4 != null) {
						globalMap.put(
								"ENABLE_TRACES_CONNECTION_tStatCatcher_1",
								Boolean.TRUE);
						if (runTrace.isPause()) {
							while (runTrace.isPause()) {
								Thread.sleep(100);
							...
							runTraceData.put("pid", String.valueOf(row4.pid));
							...
							runTraceData.put("job", String.valueOf(row4.job));
							...
							runTraceData.put("message_type",
									String.valueOf(row4.message_type));

							runTraceData.put("message",
									String.valueOf(row4.message));

							runTraceData.put("duration",
									String.valueOf(row4.duration));

							runTrace.sendTrace("row4", "tStatCatcher_1",
									runTraceData);
						}
					...
					if (row4.moment != null) {
						...
						jxl.write.WritableCell cell_0_tFileOutputExcel_2 = new jxl.write.DateTime(
								...
								// modif end
								row4.moment,
								cell_format_moment_tFileOutputExcel_2);
						// modif start
						...
						currentWith_0_tFileOutputExcel_2 = 21;
					...
					if (row4.system_pid != null) {
						...
						int currentWith_4_tFileOutputExcel_2 = String
								.valueOf(
										((jxl.write.Number) cell_4_tFileOutputExcel_2)
					...
					if (!isChildJob
							&& (Boolean) globalMap
									.get("ENABLE_TRACES_CONNECTION_tStatCatcher_1")) {
						if (globalMap.get("USE_CONDITION") != null
								&& (Boolean) globalMap.get("USE_CONDITION")) {
							if (globalMap.get("TRACE_CONDITION") != null
									&& (Boolean) globalMap
	...
	public static void main(String[] args) {
		final TestJob_Copy TestJob_CopyClass = new TestJob_Copy();

		int exitCode = TestJob_CopyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TestJob_Copy.class.getClassLoader()
					.getResourceAsStream(
							"local_project/testjob_copy_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = TestJob_Copy.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : TestJob_Copy");
		}
...
/************************************************************************************************
 * 225058 characters generated by Talend Open Studio for Data Integration on the
 * May 28, 2019 6:07:09 PM IST
 ************************************************************************************************/
