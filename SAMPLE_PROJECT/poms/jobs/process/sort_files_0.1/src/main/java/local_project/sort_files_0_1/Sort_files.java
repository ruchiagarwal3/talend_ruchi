...
package local_project.sort_files_0_1;
...
/**
 * Job: Sort_files Purpose: Sorting<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Sort_files implements TalendJob {
	...
	private final String jobName = "Sort_files";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Sort_files.this, new Object[] { e,
	...
	public static class row7Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Sort_files = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Sort_files = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Sort_files.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_Sort_files.length == 0) {
						commonByteArray_LOCAL_PROJECT_Sort_files = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Sort_files = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Sort_files, 0,
						length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_Sort_files, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Sort_files) {
	...
	public static void main(String[] args) {
		final Sort_files Sort_filesClass = new Sort_files();

		int exitCode = Sort_filesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Sort_files.class.getClassLoader()
					.getResourceAsStream(
							"local_project/sort_files_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Sort_files.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Sort_files");
		}
...
/************************************************************************************************
 * 233195 characters generated by Talend Open Studio for Data Integration on the
 * May 28, 2019 6:08:49 PM IST
 ************************************************************************************************/
