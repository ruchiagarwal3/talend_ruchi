...
package local_project.copy_of_sort_files_2_0_1;
...
/**
 * Job: Copy_of_Sort_files_2 Purpose: Sorting<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Copy_of_Sort_files_2 implements TalendJob {
	...
	private final String jobName = "Copy_of_Sort_files_2";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_Sort_files_2.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_Sort_files_2.this, new Object[] {
	...
	public void tFileOutputExcel_4_error(Exception exception,
		...
		tFileOutputExcel_4_onSubJobError(exception, errorComponent, globalMap);
	}
	...
	public void tFileOutputExcel_4_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tAssert_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tAssert_1",
						Boolean.FALSE);
				...
				if (!isChildJob
						&& (Boolean) globalMap
								.get("ENABLE_TRACES_CONNECTION_tAssert_1")) {
	...
	public static class row7Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2.length == 0) {
						commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Copy_of_Sort_files_2) {
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tStatCatcher_1.addMessage("begin", "tFlowMeter_17");
				tLogCatcher_1Process(globalMap);
				...
				tStatCatcher_1.addMessage("begin", "tFlowMeter_18");
				tLogCatcher_1Process(globalMap);
	...
	public void tFileOutputExcel_4Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		globalMap.put("tFileOutputExcel_4_SUBPROCESS_STATE", 0);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tFileOutputExcel_4",
						Boolean.FALSE);
				...
				if (!isChildJob
						&& (Boolean) globalMap
								.get("ENABLE_TRACES_CONNECTION_tFileOutputExcel_4")) {
					if (globalMap.get("USE_CONDITION") != null
							&& (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null
								&& (Boolean) globalMap.get("TRACE_CONDITION")) {
		...
		globalMap.put("tFileOutputExcel_4_SUBPROCESS_STATE", 1);
	}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap
						.put("ENABLE_TRACES_CONNECTION_tJava_1", Boolean.FALSE);
				...
				java.io.File outputFile = new java.io.File(
						"C:/Users/ruchiagarwal3/Documents/Ruchi- Deloitte/CDP 2.0/talend/console.txt");
				System.setOut(new java.io.PrintStream(
						new java.io.FileOutputStream(outputFile, true), true));
				...
				if (!isChildJob
						&& (Boolean) globalMap
								.get("ENABLE_TRACES_CONNECTION_tJava_1")) {
					if (globalMap.get("USE_CONDITION") != null
							&& (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null
								&& (Boolean) globalMap.get("TRACE_CONDITION")) {
	...
	public static class startflowStruct implements
			routines.system.IPersistableRow<startflowStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.log_type == null) ? 0 : this.log_type
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final startflowStruct other = (startflowStruct) obj;

			if (this.log_type == null) {
				if (other.log_type != null)
					return false;

			} else if (!this.log_type.equals(other.log_type))
		...
		public void copyDataTo(startflowStruct other) {
			...
			other.Source_file = this.Source_file;
			other.Target_file = this.Target_file;
			other.Row_count = this.Row_count;
			other.Row_processed = this.Row_processed;
			other.Row_rejected = this.Row_rejected;
		...
		public void copyKeysDataTo(startflowStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(startflowStruct other) {

			int returnValue = -1;

			returnValue = checkNullsAndCompare(this.log_type, other.log_type);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class updateflowStruct implements
			routines.system.IPersistableRow<updateflowStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Copy_of_Sort_files_2 = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final updateflowStruct other = (updateflowStruct) obj;
		...
		public void copyDataTo(updateflowStruct other) {
		...
		public void copyKeysDataTo(updateflowStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(updateflowStruct other) {
	...
	public void tLogCatcher_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				startflowStruct startflow = new startflowStruct();
				updateflowStruct updateflow = new updateflowStruct();

				/**
				 * [tDBOutput_2 begin ] start
				 */

				globalMap.put("ENABLE_TRACES_CONNECTION_tLogCatcher_1",
						Boolean.FALSE);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("startflow" + iterateId,
								0, 0);
				...
				String tableName_tDBOutput_2 = "Log_Table";
				...
				try (java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2
					...
					while (rsTable_tDBOutput_2.next()) {
						String table_tDBOutput_2 = rsTable_tDBOutput_2
								.getString("TABLE_NAME");
						if (table_tDBOutput_2.equalsIgnoreCase("Log_Table")) {
					...
					try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2
						...
						stmtCreate_tDBOutput_2
								.execute("CREATE TABLE `"
										...
										+ "`(`StartTime` DATETIME ,`EndTime` DATETIME ,`pid` VARCHAR(20)  ,`root_pid` VARCHAR(20)  ,`father_pid` VARCHAR(20)  ,`system_pid` BIGINT(8)  ,`project` VARCHAR(50)  ,`job` VARCHAR(255)  ,`job_repository_id` VARCHAR(255)  ,`job_version` VARCHAR(255)  ,`log_type` VARCHAR(100)  ,`context` VARCHAR(50)  ,`origin` VARCHAR(255)  ,`priority` INT(3)  ,`type` VARCHAR(255)  ,`message` VARCHAR(255)  ,`code` INT(3)  ,`duration` BIGINT(8)  ,`Source_file` VARCHAR(100)  ,`Target_file` VARCHAR(100)  ,`Row_count` INT(0)  ,`Row_processed` INT(0)  ,`Row_rejected` INT(0)  ,`language` VARCHAR(5)  ,`status` VARCHAR(10)  ,`substatus` VARCHAR(255)  ,`description` VARCHAR(255)  ,primary key(`log_type`,`origin`))");
					}
				}

				String insert_tDBOutput_2 = "INSERT INTO `"
						+ "Log_Table"
						+ "` (`StartTime`,`EndTime`,`pid`,`root_pid`,`father_pid`,`system_pid`,`project`,`job`,`job_repository_id`,`job_version`,`log_type`,`context`,`origin`,`priority`,`type`,`message`,`code`,`duration`,`Source_file`,`Target_file`,`Row_count`,`Row_processed`,`Row_rejected`,`language`,`status`,`substatus`,`description`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				int updateKeyCount_tDBOutput_3 = 7;
				...
				String tableName_tDBOutput_3 = "Log_Table";
				...
				String dbProperties_tDBOutput_3 = "useUnicode=true&characterEncoding=utf8";
				...
				if (dbProperties_tDBOutput_3 == null
					...
					String properties_tDBOutput_3 = "useUnicode=true&characterEncoding=utf8";
				...
				String update_tDBOutput_3 = "UPDATE `"
						+ "Log_Table"
						+ "` SET `EndTime` = ?,`pid` = ?,`root_pid` = ?,`father_pid` = ?,`system_pid` = ?,`project` = ?,`job` = ?,`job_repository_id` = ?,`job_version` = ?,`log_type` = ?,`context` = ?,`origin` = ?,`priority` = ?,`type` = ?,`message` = ?,`code` = ?,`duration` = ?,`Source_file` = ?,`Target_file` = ?,`Row_count` = ?,`Row_processed` = ?,`Row_rejected` = ?,`language` = ?,`status` = ?,`substatus` = ?,`description` = ? WHERE `EndTime` = ? AND `type` = ? AND `message` = ? AND `duration` = ? AND `Row_count` = ? AND `Row_processed` = ? AND `Row_rejected` = ?";
				...
				// ###############################
				// # Outputs initialization
				startflowStruct startflow_tmp = new startflowStruct();
				updateflowStruct updateflow_tmp = new updateflowStruct();
				// ###############################
				...
				try {
					for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
						...
						if (row4 != null) {
							globalMap.put(
									"ENABLE_TRACES_CONNECTION_tLogCatcher_1",
									Boolean.TRUE);
							if (runTrace.isPause()) {
								while (runTrace.isPause()) {
									Thread.sleep(100);
								...
								runTraceData.put("moment",
										String.valueOf(row4.moment));

								runTraceData.put("pid",
										String.valueOf(row4.pid));

								runTraceData.put("root_pid",
										String.valueOf(row4.root_pid));

								runTraceData.put("father_pid",
										String.valueOf(row4.father_pid));

								runTraceData.put("project",
										String.valueOf(row4.project));

								runTraceData.put("job",
										String.valueOf(row4.job));

								runTraceData.put("context",
										String.valueOf(row4.context));

								runTraceData.put("priority",
										String.valueOf(row4.priority));

								runTraceData.put("type",
										String.valueOf(row4.type));

								runTraceData.put("origin",
										String.valueOf(row4.origin));

								runTraceData.put("message",
										String.valueOf(row4.message));

								runTraceData.put("code",
										String.valueOf(row4.code));

								runTrace.sendTrace("row4", "tLogCatcher_1",
										runTraceData);
							}
						...
						// schema
						row5.moment = row4.moment;
						row5.pid = row4.pid;
						row5.root_pid = row4.root_pid;
						row5.father_pid = row4.father_pid;
						row5.project = row4.project;
						row5.job = row4.job;
						row5.context = row4.context;
						row5.priority = row4.priority;
						row5.type = row4.type;
						row5.origin = row4.origin;
						row5.message = row4.message;
						row5.code = row4.code;
						row5.system_pid = null;
						row5.job_version = null;
						row5.Job_repository_id = null;
						row5.duration = null;
						row5.Source_file = context.InputFilePath
								+ context.InputFileName;
						row5.Target_file = context.OutputFilePath
								+ context.OutputFileName;
						row5.Row_count = ((Integer) globalMap
								.get("tFileInputDelimited_1_NB_LINE"));
						row5.Row_processed = ((Integer) globalMap
								.get("tFileOutputExcel_1_NB_LINE"));
						row5.Row_rejected = 0;
						...
						if (row5 != null) {
							...
							if (runTrace.isPause()) {
								...
								runTraceData.put("system_pid",
										String.valueOf(row5.system_pid));

								runTraceData.put("code",
										String.valueOf(row5.code));

								runTraceData.put("Job_repository_id",
										String.valueOf(row5.Job_repository_id));

								runTraceData.put("job_version",
										String.valueOf(row5.job_version));

								runTraceData.put("duration",
										String.valueOf(row5.duration));

								runTraceData.put("Source_file",
										String.valueOf(row5.Source_file));

								runTraceData.put("Target_file",
										String.valueOf(row5.Target_file));

								runTraceData.put("Row_count",
										String.valueOf(row5.Row_count));

								runTraceData.put("Row_processed",
										String.valueOf(row5.Row_processed));

								runTraceData.put("Row_rejected",
										String.valueOf(row5.Row_rejected));

								runTrace.sendTrace("row5", "tLogCatcher_1",
										runTraceData);
							}
						...
						{ // start of Var scope
							...
							logData_tmp.moment = row5.moment;
							logData_tmp.pid = row5.pid;
							logData_tmp.root_pid = row5.root_pid;
							logData_tmp.father_pid = row5.father_pid;
							logData_tmp.system_pid = row5.system_pid;
							logData_tmp.project = row5.project;
							logData_tmp.job = row5.job;
							logData_tmp.job_repository_id = row5.Job_repository_id;
							logData_tmp.job_version = row5.job_version;
							logData_tmp.log_type = "Error Log";
							logData_tmp.context = row5.context;
							logData_tmp.origin = row5.origin;
							logData_tmp.priority = row5.priority;
							logData_tmp.type = row5.type;
							logData_tmp.message = row5.message;
							logData_tmp.code = row5.code;
							logData_tmp.duration = row5.duration;
							logData_tmp.Source_file = row5.Source_file;
							logData_tmp.Target_file = row5.Target_file;
							logData_tmp.Row_count = row5.Row_count;
							logData_tmp.Row_processed = row5.Row_processed;
							logData_tmp.Row_rejected = row5.Row_rejected;
							logData_tmp.language = null;
							logData_tmp.status = null;
							logData_tmp.substatus = null;
							logData_tmp.description = null;
							logData = logData_tmp;
							// ###############################
						...
						if (logData != null) {
							...
							if (runTrace.isPause()) {
								...
								runTraceData.put("moment",
										String.valueOf(logData.moment));

								runTraceData.put("pid",
										String.valueOf(logData.pid));

								runTraceData.put("root_pid",
										String.valueOf(logData.root_pid));

								runTraceData.put("father_pid",
										String.valueOf(logData.father_pid));

								runTraceData.put("system_pid",
										String.valueOf(logData.system_pid));

								runTraceData.put("project",
										String.valueOf(logData.project));

								runTraceData.put("job",
										String.valueOf(logData.job));

								runTraceData.put("job_repository_id", String
										.valueOf(logData.job_repository_id));

								runTraceData.put("job_version",
										String.valueOf(logData.job_version));

								runTraceData.put("log_type",
										String.valueOf(logData.log_type));

								runTraceData.put("context",
										String.valueOf(logData.context));

								runTraceData.put("origin",
										String.valueOf(logData.origin));

								runTraceData.put("priority",
										String.valueOf(logData.priority));

								runTraceData.put("type",
										String.valueOf(logData.type));

								runTraceData.put("message",
										String.valueOf(logData.message));

								runTraceData.put("code",
										String.valueOf(logData.code));

								runTraceData.put("duration",
										String.valueOf(logData.duration));

								runTraceData.put("Source_file",
										String.valueOf(logData.Source_file));

								runTraceData.put("Target_file",
										String.valueOf(logData.Target_file));

								runTraceData.put("Row_count",
										String.valueOf(logData.Row_count));

								runTraceData.put("Row_processed",
										String.valueOf(logData.Row_processed));

								runTraceData.put("Row_rejected",
										String.valueOf(logData.Row_rejected));

								runTraceData.put("language",
										String.valueOf(logData.language));

								runTraceData.put("status",
										String.valueOf(logData.status));

								runTraceData.put("substatus",
										String.valueOf(logData.substatus));

								runTraceData.put("description",
										String.valueOf(logData.description));

								runTrace.sendTrace("logData", "tLogCatcher_1",
										runTraceData);
							}
						...
						if (logData != null) {
							...
							row9.language = logData.language;
							row9.status = logData.status;
							row9.substatus = logData.substatus;
							row9.description = logData.description;
							...
							if (row9 != null) {
								globalMap
										.put("ENABLE_TRACES_CONNECTION_tLogCatcher_1",
												Boolean.TRUE);
								if (runTrace.isPause()) {
									while (runTrace.isPause()) {
										Thread.sleep(100);
									...
									runTraceData.put("duration",
											String.valueOf(row9.duration));

									runTraceData.put("Source_file",
											String.valueOf(row9.Source_file));

									runTraceData.put("Target_file",
											String.valueOf(row9.Target_file));

									runTraceData.put("Row_count",
											String.valueOf(row9.Row_count));

									runTraceData.put("Row_processed",
											String.valueOf(row9.Row_processed));

									runTraceData.put("Row_rejected",
											String.valueOf(row9.Row_rejected));

									runTraceData.put("language",
											String.valueOf(row9.language));

									runTraceData.put("status",
											String.valueOf(row9.status));

									runTraceData.put("substatus",
											String.valueOf(row9.substatus));

									runTraceData.put("description",
											String.valueOf(row9.description));

									runTrace.sendTrace("row9", "tLogCatcher_1",
											runTraceData);
								}
							...
							{ // start of Var scope
								...
								// # Output table : 'startflow'
								startflow_tmp.StartTime = (row9.type == "begin") ? row9.moment
										: null;
								startflow_tmp.EndTime = null;
								startflow_tmp.pid = row9.pid;
								startflow_tmp.root_pid = row9.root_pid;
								startflow_tmp.father_pid = row9.father_pid;
								startflow_tmp.system_pid = row9.system_pid;
								startflow_tmp.project = row9.project;
								startflow_tmp.job = row9.job;
								startflow_tmp.job_repository_id = row9.job_repository_id;
								startflow_tmp.job_version = row9.job_version;
								startflow_tmp.log_type = row9.log_type;
								startflow_tmp.context = row9.context;
								startflow_tmp.origin = (row9.origin == null) ? "Main Job"
										: row9.origin;
								startflow_tmp.priority = row9.priority;
								startflow_tmp.type = row9.type;
								startflow_tmp.message = row9.message;
								startflow_tmp.code = row9.code;
								startflow_tmp.duration = row9.duration;
								startflow_tmp.Source_file = row9.Source_file;
								startflow_tmp.Target_file = row9.Target_file;
								startflow_tmp.Row_count = row9.Row_count;
								startflow_tmp.Row_processed = row9.Row_processed;
								startflow_tmp.Row_rejected = row9.Row_rejected;
								startflow_tmp.language = row9.language;
								startflow_tmp.status = row9.status;
								startflow_tmp.substatus = row9.substatus;
								startflow_tmp.description = row9.description;
								startflow = startflow_tmp;

								// # Output table : 'updateflow'
								updateflow_tmp.StartTime = null;
								updateflow_tmp.EndTime = (row9.type == "end") ? row9.moment
										: null;
								updateflow_tmp.pid = row9.pid;
								updateflow_tmp.root_pid = row9.root_pid;
								updateflow_tmp.father_pid = row9.father_pid;
								updateflow_tmp.system_pid = row9.system_pid;
								updateflow_tmp.project = row9.project;
								updateflow_tmp.job = row9.job;
								updateflow_tmp.job_repository_id = row9.job_repository_id;
								updateflow_tmp.job_version = row9.job_version;
								updateflow_tmp.log_type = row9.log_type;
								updateflow_tmp.context = row9.context;
								updateflow_tmp.origin = (row9.origin == null) ? "Main Job"
										: row9.origin;
								updateflow_tmp.priority = row9.priority;
								updateflow_tmp.type = row9.type;
								updateflow_tmp.message = row9.message;
								updateflow_tmp.code = row9.code;
								updateflow_tmp.duration = row9.duration;
								updateflow_tmp.Source_file = row9.Source_file;
								updateflow_tmp.Target_file = row9.Target_file;
								updateflow_tmp.Row_count = row9.Row_count;
								updateflow_tmp.Row_processed = row9.Row_processed;
								updateflow_tmp.Row_rejected = row9.Row_rejected;
								updateflow_tmp.language = row9.language;
								updateflow_tmp.status = row9.status;
								updateflow_tmp.substatus = row9.substatus;
								updateflow_tmp.description = row9.description;
								updateflow = updateflow_tmp;
								// ###############################
							...
							if (startflow != null) {
								...
								if (runTrace.isPause()) {
									...
									runTraceData
											.put("StartTime",
													String.valueOf(startflow.StartTime));

									runTraceData.put("EndTime",
											String.valueOf(startflow.EndTime));

									runTraceData.put("pid",
											String.valueOf(startflow.pid));

									runTraceData.put("root_pid",
											String.valueOf(startflow.root_pid));

									runTraceData.put("father_pid", String
											.valueOf(startflow.father_pid));

									runTraceData.put("system_pid", String
											.valueOf(startflow.system_pid));

									runTraceData.put("project",
											String.valueOf(startflow.project));

									runTraceData.put("job",
											String.valueOf(startflow.job));

									runTraceData
											.put("job_repository_id",
													String.valueOf(startflow.job_repository_id));

									runTraceData.put("job_version", String
											.valueOf(startflow.job_version));

									runTraceData.put("log_type",
											String.valueOf(startflow.log_type));

									runTraceData.put("context",
											String.valueOf(startflow.context));

									runTraceData.put("origin",
											String.valueOf(startflow.origin));

									runTraceData.put("priority",
											String.valueOf(startflow.priority));

									runTraceData.put("type",
											String.valueOf(startflow.type));

									runTraceData.put("message",
											String.valueOf(startflow.message));

									runTraceData.put("code",
											String.valueOf(startflow.code));

									runTraceData.put("duration",
											String.valueOf(startflow.duration));

									runTraceData.put("Source_file", String
											.valueOf(startflow.Source_file));

									runTraceData.put("Target_file", String
											.valueOf(startflow.Target_file));

									runTraceData
											.put("Row_count",
													String.valueOf(startflow.Row_count));

									runTraceData.put("Row_processed", String
											.valueOf(startflow.Row_processed));

									runTraceData.put("Row_rejected", String
											.valueOf(startflow.Row_rejected));

									runTraceData.put("language",
											String.valueOf(startflow.language));

									runTraceData.put("status",
											String.valueOf(startflow.status));

									runTraceData
											.put("substatus",
													String.valueOf(startflow.substatus));

									runTraceData.put("description", String
											.valueOf(startflow.description));

									runTrace.sendTrace("startflow",
											"tLogCatcher_1", runTraceData);
								}
							...
							if (updateflow != null) {
								...
								if (runTrace.isPause()) {
									...
									runTraceData.put("StartTime", String
											.valueOf(updateflow.StartTime));

									runTraceData.put("EndTime",
											String.valueOf(updateflow.EndTime));

									runTraceData.put("pid",
											String.valueOf(updateflow.pid));

									runTraceData
											.put("root_pid",
													String.valueOf(updateflow.root_pid));

									runTraceData.put("father_pid", String
											.valueOf(updateflow.father_pid));

									runTraceData.put("system_pid", String
											.valueOf(updateflow.system_pid));

									runTraceData.put("project",
											String.valueOf(updateflow.project));

									runTraceData.put("job",
											String.valueOf(updateflow.job));

									runTraceData
											.put("job_repository_id",
													String.valueOf(updateflow.job_repository_id));

									runTraceData.put("job_version", String
											.valueOf(updateflow.job_version));

									runTraceData
											.put("log_type",
													String.valueOf(updateflow.log_type));

									runTraceData.put("context",
											String.valueOf(updateflow.context));

									runTraceData.put("origin",
											String.valueOf(updateflow.origin));

									runTraceData
											.put("priority",
													String.valueOf(updateflow.priority));

									runTraceData.put("type",
											String.valueOf(updateflow.type));

									runTraceData.put("message",
											String.valueOf(updateflow.message));

									runTraceData.put("code",
											String.valueOf(updateflow.code));

									runTraceData
											.put("duration",
													String.valueOf(updateflow.duration));

									runTraceData.put("Source_file", String
											.valueOf(updateflow.Source_file));

									runTraceData.put("Target_file", String
											.valueOf(updateflow.Target_file));

									runTraceData.put("Row_count", String
											.valueOf(updateflow.Row_count));

									runTraceData.put("Row_processed", String
											.valueOf(updateflow.Row_processed));

									runTraceData.put("Row_rejected", String
											.valueOf(updateflow.Row_rejected));

									runTraceData
											.put("language",
													String.valueOf(updateflow.language));

									runTraceData.put("status",
											String.valueOf(updateflow.status));

									runTraceData.put("substatus", String
											.valueOf(updateflow.substatus));

									runTraceData.put("description", String
											.valueOf(updateflow.description));

									runTrace.sendTrace("updateflow",
											"tLogCatcher_1", runTraceData);
								}
							...
							if (startflow != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection("startflow"
											+ iterateId, 1, 1);
								}

								whetherReject_tDBOutput_2 = false;
								if (startflow.StartTime != null) {
									date_tDBOutput_2 = startflow.StartTime
											.getTime();
								...
								if (startflow.EndTime != null) {
									date_tDBOutput_2 = startflow.EndTime
											.getTime();
									if (date_tDBOutput_2 < year1_tDBOutput_2
											|| date_tDBOutput_2 >= year10000_tDBOutput_2) {
										...
										pstmt_tDBOutput_2.setTimestamp(2,
												new java.sql.Timestamp(
														date_tDBOutput_2));
									}
								} else {
								...
								if (startflow.father_pid == null) {
									pstmt_tDBOutput_2.setNull(5,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(5,
											startflow.father_pid);
								}

								if (startflow.system_pid == null) {
									pstmt_tDBOutput_2.setNull(6,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setLong(6,
											startflow.system_pid);
								}

								if (startflow.project == null) {
								...
								if (startflow.job_repository_id == null) {
									pstmt_tDBOutput_2.setNull(9,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(9,
											startflow.job_repository_id);
								}

								if (startflow.job_version == null) {
									pstmt_tDBOutput_2.setNull(10,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(10,
											startflow.job_version);
								}

								if (startflow.log_type == null) {
								...
								if (startflow.code == null) {
									pstmt_tDBOutput_2.setNull(17,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2
											.setInt(17, startflow.code);
								}

								if (startflow.duration == null) {
									pstmt_tDBOutput_2.setNull(18,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setLong(18,
											startflow.duration);
								}

								if (startflow.Source_file == null) {
									pstmt_tDBOutput_2.setNull(19,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(19,
											startflow.Source_file);
								}

								if (startflow.Target_file == null) {
									pstmt_tDBOutput_2.setNull(20,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(20,
											startflow.Target_file);
								}

								if (startflow.Row_count == null) {
									pstmt_tDBOutput_2.setNull(21,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(21,
											startflow.Row_count);
								}

								if (startflow.Row_processed == null) {
									pstmt_tDBOutput_2.setNull(22,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(22,
											startflow.Row_processed);
								}

								if (startflow.Row_rejected == null) {
									pstmt_tDBOutput_2.setNull(23,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(23,
											startflow.Row_rejected);
								}

								if (startflow.language == null) {
							...
							} // End of branch "startflow"

							// Start of branch "updateflow"
							if (updateflow != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection("updateflow"
											+ iterateId, 1, 1);
								}

								whetherReject_tDBOutput_3 = false;
								if (updateflow.EndTime != null) {
									date_tDBOutput_3 = updateflow.EndTime
											.getTime();
									if (date_tDBOutput_3 < year1_tDBOutput_3
										...
										pstmt_tDBOutput_3.setTimestamp(1,
												new java.sql.Timestamp(
														date_tDBOutput_3));
									}
								} else {
								...
								if (updateflow.father_pid == null) {
									pstmt_tDBOutput_3.setNull(4,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(4,
											updateflow.father_pid);
								}

								if (updateflow.system_pid == null) {
									pstmt_tDBOutput_3.setNull(5,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setLong(5,
											updateflow.system_pid);
								}

								if (updateflow.project == null) {
								...
								if (updateflow.job_repository_id == null) {
									pstmt_tDBOutput_3.setNull(8,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(8,
											updateflow.job_repository_id);
								}

								if (updateflow.job_version == null) {
									pstmt_tDBOutput_3.setNull(9,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(9,
											updateflow.job_version);
								}

								if (updateflow.log_type == null) {
								...
								if (updateflow.priority == null) {
									pstmt_tDBOutput_3.setNull(13,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setInt(13,
											updateflow.priority);
								}

								if (updateflow.type == null) {
									pstmt_tDBOutput_3.setNull(14,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(14,
											updateflow.type);
								}

								if (updateflow.message == null) {
									pstmt_tDBOutput_3.setNull(15,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(15,
											updateflow.message);
								}

								if (updateflow.code == null) {
									pstmt_tDBOutput_3.setNull(16,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setInt(16,
											updateflow.code);
								}

								if (updateflow.duration == null) {
									pstmt_tDBOutput_3.setNull(17,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setLong(17,
											updateflow.duration);
								}

								if (updateflow.Source_file == null) {
									pstmt_tDBOutput_3.setNull(18,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(18,
											updateflow.Source_file);
								}

								if (updateflow.Target_file == null) {
									pstmt_tDBOutput_3.setNull(19,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(19,
											updateflow.Target_file);
								}

								if (updateflow.Row_count == null) {
									pstmt_tDBOutput_3.setNull(20,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setInt(20,
											updateflow.Row_count);
								}

								if (updateflow.Row_processed == null) {
									pstmt_tDBOutput_3.setNull(21,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setInt(21,
											updateflow.Row_processed);
								}

								if (updateflow.Row_rejected == null) {
									pstmt_tDBOutput_3.setNull(22,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setInt(22,
											updateflow.Row_rejected);
								}

								if (updateflow.language == null) {
									pstmt_tDBOutput_3.setNull(23,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(23,
											updateflow.language);
								}

								if (updateflow.status == null) {
									pstmt_tDBOutput_3.setNull(24,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(24,
											updateflow.status);
								}

								if (updateflow.substatus == null) {
									pstmt_tDBOutput_3.setNull(25,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(25,
											updateflow.substatus);
								}

								if (updateflow.description == null) {
									pstmt_tDBOutput_3.setNull(26,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_3.setString(26,
											updateflow.description);
								}

								if (updateflow.EndTime != null) {
									pstmt_tDBOutput_3.setTimestamp(
											27 + count_tDBOutput_3,
											new java.sql.Timestamp(
													updateflow.EndTime
															.getTime()));
								} else {
								...
								if (updateflow.Row_count == null) {
									pstmt_tDBOutput_3.setNull(
											31 + count_tDBOutput_3,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_3.setInt(
											31 + count_tDBOutput_3,
											updateflow.Row_count);
								}
						...
						if (!isChildJob
								&& (Boolean) globalMap
										.get("ENABLE_TRACES_CONNECTION_tLogCatcher_1")) {
							if (globalMap.get("USE_CONDITION") != null
									&& (Boolean) globalMap.get("USE_CONDITION")) {
								if (globalMap.get("TRACE_CONDITION") != null
										&& (Boolean) globalMap
				...
				for (StatCatcherUtils.StatCatcherMessage scm : tStatCatcher_1
					...
					if (row3 != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("moment",
									String.valueOf(row3.moment));

							runTraceData.put("pid", String.valueOf(row3.pid));
							...
							runTraceData.put("job", String.valueOf(row3.job));
							...
							runTrace.sendTrace("row3", "tLogCatcher_1",
									runTraceData);
						}
					...
					// Code generated according to input schema and output
					// schema
					row6.moment = row3.moment;
					row6.pid = row3.pid;
					row6.father_pid = row3.father_pid;
					row6.root_pid = row3.root_pid;
					row6.system_pid = row3.system_pid;
					row6.project = row3.project;
					row6.job = row3.job;
					row6.job_repository_id = row3.job_repository_id;
					row6.job_version = row3.job_version;
					row6.context = row3.context;
					row6.origin = row3.origin;
					row6.message_type = row3.message_type;
					row6.message = row3.message;
					row6.code = null;
					row6.duration = row3.duration;
					row6.Source_file = context.InputFilePath
							+ context.InputFileName;
					row6.Target_file = context.OutputFilePath
							+ context.OutputFileName;
					row6.Row_count = ((Integer) globalMap
							.get("tFileInputDelimited_1_NB_LINE"));
					row6.Row_processed = ((Integer) globalMap
							.get("tFileOutputExcel_1_NB_LINE"));
					row6.Row_rejected = 0;
					row6.priority = null;
					nb_line_tJavaRow_1++;
					...
					if (row6 != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("moment",
									String.valueOf(row6.moment));

							runTraceData.put("pid", String.valueOf(row6.pid));
							...
							runTraceData.put("job", String.valueOf(row6.job));
							...
							runTraceData.put("message_type",
									String.valueOf(row6.message_type));

							runTraceData.put("message",
									String.valueOf(row6.message));

							runTraceData.put("duration",
									String.valueOf(row6.duration));

							runTraceData.put("Source_file",
									String.valueOf(row6.Source_file));

							runTraceData.put("Target_file",
									String.valueOf(row6.Target_file));

							runTraceData.put("Row_count",
									String.valueOf(row6.Row_count));

							runTraceData.put("Row_processed",
									String.valueOf(row6.Row_processed));

							runTraceData.put("Row_rejected",
									String.valueOf(row6.Row_rejected));

							runTraceData.put("code", String.valueOf(row6.code));

							runTraceData.put("priority",
									String.valueOf(row6.priority));

							runTrace.sendTrace("row6", "tLogCatcher_1",
									runTraceData);
						}
					...
					{ // start of Var scope
						...
						StatData_tmp.moment = row6.moment;
						StatData_tmp.pid = row6.pid;
						StatData_tmp.root_pid = row6.root_pid;
						StatData_tmp.father_pid = row6.father_pid;
						StatData_tmp.system_pid = row6.system_pid;
						StatData_tmp.project = row6.project;
						StatData_tmp.job = row6.job;
						StatData_tmp.job_repository_id = row6.job_repository_id;
						StatData_tmp.job_version = row6.job_version;
						StatData_tmp.log_type = "Statistics Log";
						StatData_tmp.context = row6.context;
						StatData_tmp.origin = row6.origin;
						StatData_tmp.priority = row6.priority;
						StatData_tmp.type = row6.message_type;
						StatData_tmp.message = row6.message;
						StatData_tmp.code = row6.code;
						StatData_tmp.duration = row6.duration;
						StatData_tmp.Source_file = row6.Source_file;
						StatData_tmp.Target_file = row6.Target_file;
						StatData_tmp.Row_count = row6.Row_count;
						StatData_tmp.Row_processed = row6.Row_processed;
						StatData_tmp.Row_rejected = row6.Row_rejected;
						StatData_tmp.language = null;
						StatData_tmp.status = null;
						StatData_tmp.substatus = null;
						StatData_tmp.description = null;
					...
					if (StatData != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("moment",
									String.valueOf(StatData.moment));

							runTraceData.put("pid",
									String.valueOf(StatData.pid));

							runTraceData.put("root_pid",
									String.valueOf(StatData.root_pid));

							runTraceData.put("father_pid",
									String.valueOf(StatData.father_pid));

							runTraceData.put("system_pid",
									String.valueOf(StatData.system_pid));

							runTraceData.put("project",
									String.valueOf(StatData.project));

							runTraceData.put("job",
									String.valueOf(StatData.job));

							runTraceData.put("job_repository_id",
									String.valueOf(StatData.job_repository_id));

							runTraceData.put("job_version",
									String.valueOf(StatData.job_version));

							runTraceData.put("log_type",
									String.valueOf(StatData.log_type));

							runTraceData.put("context",
									String.valueOf(StatData.context));

							runTraceData.put("origin",
									String.valueOf(StatData.origin));

							runTraceData.put("priority",
									String.valueOf(StatData.priority));

							runTraceData.put("type",
									String.valueOf(StatData.type));

							runTraceData.put("message",
									String.valueOf(StatData.message));

							runTraceData.put("code",
									String.valueOf(StatData.code));

							runTraceData.put("duration",
									String.valueOf(StatData.duration));

							runTraceData.put("Source_file",
									String.valueOf(StatData.Source_file));

							runTraceData.put("Target_file",
									String.valueOf(StatData.Target_file));

							runTraceData.put("Row_count",
									String.valueOf(StatData.Row_count));

							runTraceData.put("Row_processed",
									String.valueOf(StatData.Row_processed));

							runTraceData.put("Row_rejected",
									String.valueOf(StatData.Row_rejected));

							runTraceData.put("language",
									String.valueOf(StatData.language));

							runTraceData.put("status",
									String.valueOf(StatData.status));

							runTraceData.put("substatus",
									String.valueOf(StatData.substatus));

							runTraceData.put("description",
									String.valueOf(StatData.description));

							runTrace.sendTrace("StatData", "tLogCatcher_1",
									runTraceData);
						}
					...
					if (StatData != null) {
						...
						row9.language = StatData.language;
						row9.status = StatData.status;
						row9.substatus = StatData.substatus;
						row9.description = StatData.description;
						...
						if (startflow != null) {
							...
							if (runTrace.isPause()) {
								...
								runTraceData.put("father_pid",
										String.valueOf(startflow.father_pid));

								runTraceData.put("system_pid",
										String.valueOf(startflow.system_pid));
								...
								runTraceData.put("job_repository_id", String
										.valueOf(startflow.job_repository_id));

								runTraceData.put("job_version",
										String.valueOf(startflow.job_version));
								...
								runTraceData.put("Source_file",
										String.valueOf(startflow.Source_file));

								runTraceData.put("Target_file",
										String.valueOf(startflow.Target_file));
								...
								runTraceData
										.put("Row_processed",
												String.valueOf(startflow.Row_processed));

								runTraceData.put("Row_rejected",
										String.valueOf(startflow.Row_rejected));
								...
								runTraceData.put("description",
										String.valueOf(startflow.description));
						...
						if (updateflow != null) {
							...
							if (runTrace.isPause()) {
								...
								runTraceData.put("StartTime",
										String.valueOf(updateflow.StartTime));
								...
								runTraceData.put("father_pid",
										String.valueOf(updateflow.father_pid));

								runTraceData.put("system_pid",
										String.valueOf(updateflow.system_pid));
								...
								runTraceData.put("job_repository_id", String
										.valueOf(updateflow.job_repository_id));

								runTraceData.put("job_version",
										String.valueOf(updateflow.job_version));
								...
								runTraceData.put("Source_file",
										String.valueOf(updateflow.Source_file));

								runTraceData.put("Target_file",
										String.valueOf(updateflow.Target_file));

								runTraceData.put("Row_count",
										String.valueOf(updateflow.Row_count));
								...
								runTraceData
										.put("Row_rejected",
												String.valueOf(updateflow.Row_rejected));
								...
								runTraceData.put("substatus",
										String.valueOf(updateflow.substatus));

								runTraceData.put("description",
										String.valueOf(updateflow.description));
						...
						if (startflow != null) {
							...
							if (startflow.EndTime != null) {
								date_tDBOutput_2 = startflow.EndTime.getTime();
								if (date_tDBOutput_2 < year1_tDBOutput_2
										|| date_tDBOutput_2 >= year10000_tDBOutput_2) {
									pstmt_tDBOutput_2.setString(2,
											"0000-00-00 00:00:00");
							...
							if (startflow.pid == null) {
								...
								pstmt_tDBOutput_2.setString(3, startflow.pid);
							}
							...
							if (startflow.job == null) {
								...
								pstmt_tDBOutput_2.setString(8, startflow.job);
							}
							...
							if (startflow.type == null) {
								...
								pstmt_tDBOutput_2.setString(15, startflow.type);
							}
							...
							if (startflow.code == null) {
								...
								pstmt_tDBOutput_2.setInt(17, startflow.code);
							}
						...
						if (updateflow != null) {
							...
							whetherReject_tDBOutput_3 = false;
							if (updateflow.EndTime != null) {
								date_tDBOutput_3 = updateflow.EndTime.getTime();
								if (date_tDBOutput_3 < year1_tDBOutput_3
										|| date_tDBOutput_3 >= year10000_tDBOutput_3) {
									pstmt_tDBOutput_3.setString(1,
											"0000-00-00 00:00:00");
							...
							if (updateflow.pid == null) {
								...
								pstmt_tDBOutput_3.setString(2, updateflow.pid);
							}
							...
							if (updateflow.job == null) {
								...
								pstmt_tDBOutput_3.setString(7, updateflow.job);
							}
							...
							if (updateflow.code == null) {
								...
								pstmt_tDBOutput_3.setInt(16, updateflow.code);
							}
							...
							if (updateflow.type == null) {
								...
								pstmt_tDBOutput_3
										.setString(28 + count_tDBOutput_3,
												updateflow.type);
							}
				...
				for (AssertCatcherUtils.AssertCatcherMessage acm : tAssertCatcher_1
						.getMessages()) {
					row11.moment = acm.getMoment();
					row11.pid = acm.getPid();
					row11.project = acm.getProject();
					row11.job = acm.getJob();
					row11.language = acm.getLanguage();

					row11.origin = (acm.getOrigin() == null
							|| acm.getOrigin().length() < 1 ? null : acm
							.getOrigin());

					row11.status = acm.getStatus();
					row11.substatus = acm.getSubstatus();
					row11.description = acm.getDescription();
					...
					if (row11 != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("moment",
									String.valueOf(row11.moment));

							runTraceData.put("pid", String.valueOf(row11.pid));

							runTraceData.put("project",
									String.valueOf(row11.project));

							runTraceData.put("job", String.valueOf(row11.job));

							runTraceData.put("language",
									String.valueOf(row11.language));

							runTraceData.put("origin",
									String.valueOf(row11.origin));

							runTraceData.put("status",
									String.valueOf(row11.status));

							runTraceData.put("substatus",
									String.valueOf(row11.substatus));

							runTraceData.put("description",
									String.valueOf(row11.description));

							runTrace.sendTrace("row11", "tLogCatcher_1",
									runTraceData);
						}
					...
					// Code generated according to input schema and output
					// schema
					row12.moment = row11.moment;
					row12.pid = row11.pid;
					row12.project = row11.project;
					row12.job = row11.job;
					row12.language = row11.language;
					row12.origin = row11.origin;
					row12.status = row11.status;
					row12.substatus = row11.substatus;
					row12.description = row11.description;
					row12.father_pid = null;
					row12.system_pid = null;
					row12.job_repository_id = null;
					row12.job_version = null;
					row12.context = null;
					row12.priority = null;
					row12.type = null;
					row12.root_pid = null;
					...
					row12.code = null;
					row12.duration = null;
					row12.Source_file = context.InputFilePath
							+ context.InputFileName;
					row12.Target_file = context.OutputFilePath
							+ context.OutputFileName;
					row12.Row_count = ((Integer) globalMap
							.get("tFileInputDelimited_1_NB_LINE"));
					row12.Row_processed = ((Integer) globalMap
							.get("tFileOutputExcel_INSERTED_1_NB_LINE"));
					row12.Row_rejected = ((Integer) globalMap
							.get("tFileOutputExcel_REJECTED_1_NB_LINE"));
					...
					if (row12 != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("moment",
									String.valueOf(row12.moment));

							runTraceData.put("pid", String.valueOf(row12.pid));

							runTraceData.put("project",
									String.valueOf(row12.project));

							runTraceData.put("job", String.valueOf(row12.job));

							runTraceData.put("language",
									String.valueOf(row12.language));

							runTraceData.put("origin",
									String.valueOf(row12.origin));

							runTraceData.put("status",
									String.valueOf(row12.status));

							runTraceData.put("substatus",
									String.valueOf(row12.substatus));

							runTraceData.put("description",
									String.valueOf(row12.description));
							...
							runTraceData.put("priority",
									String.valueOf(row12.priority));

							runTraceData
									.put("type", String.valueOf(row12.type));

							runTraceData.put("root_pid",
									String.valueOf(row12.root_pid));

							runTraceData.put("message",
									String.valueOf(row12.message));

							runTraceData
									.put("code", String.valueOf(row12.code));

							runTraceData.put("duration",
									String.valueOf(row12.duration));

							runTraceData.put("Source_file",
									String.valueOf(row12.Source_file));

							runTraceData.put("Target_file",
									String.valueOf(row12.Target_file));

							runTraceData.put("Row_count",
									String.valueOf(row12.Row_count));

							runTraceData.put("Row_processed",
									String.valueOf(row12.Row_processed));

							runTraceData.put("Row_rejected",
									String.valueOf(row12.Row_rejected));

							runTrace.sendTrace("row12", "tLogCatcher_1",
									runTraceData);
						}
					...
					{ // start of Var scope
						...
						Assert_Data_tmp.moment = row12.moment;
						Assert_Data_tmp.pid = row12.pid;
						Assert_Data_tmp.root_pid = row12.root_pid;
						Assert_Data_tmp.father_pid = row12.father_pid;
						Assert_Data_tmp.system_pid = row12.system_pid;
						Assert_Data_tmp.project = row12.project;
						Assert_Data_tmp.job = row12.job;
						Assert_Data_tmp.job_repository_id = row12.job_repository_id;
						Assert_Data_tmp.job_version = row12.job_version;
						Assert_Data_tmp.log_type = "Assert Log";
						Assert_Data_tmp.context = row12.context;
						Assert_Data_tmp.origin = row12.origin;
						Assert_Data_tmp.priority = row12.priority;
						Assert_Data_tmp.type = row12.type;
						Assert_Data_tmp.message = row12.message;
						Assert_Data_tmp.code = row12.code;
						Assert_Data_tmp.duration = row12.duration;
						Assert_Data_tmp.Source_file = row12.Source_file;
						Assert_Data_tmp.Target_file = row12.Target_file;
						Assert_Data_tmp.Row_count = row12.Row_count;
						Assert_Data_tmp.Row_processed = row12.Row_processed;
						Assert_Data_tmp.Row_rejected = row12.Row_rejected;
						Assert_Data_tmp.language = row12.language;
						Assert_Data_tmp.status = row12.status;
						Assert_Data_tmp.substatus = row12.substatus;
						Assert_Data_tmp.description = row12.description;
					...
					if (Assert_Data != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("moment",
									String.valueOf(Assert_Data.moment));

							runTraceData.put("pid",
									String.valueOf(Assert_Data.pid));

							runTraceData.put("root_pid",
									String.valueOf(Assert_Data.root_pid));

							runTraceData.put("father_pid",
									String.valueOf(Assert_Data.father_pid));

							runTraceData.put("system_pid",
									String.valueOf(Assert_Data.system_pid));

							runTraceData.put("project",
									String.valueOf(Assert_Data.project));

							runTraceData.put("job",
									String.valueOf(Assert_Data.job));

							runTraceData.put("job_repository_id", String
									.valueOf(Assert_Data.job_repository_id));

							runTraceData.put("job_version",
									String.valueOf(Assert_Data.job_version));

							runTraceData.put("log_type",
									String.valueOf(Assert_Data.log_type));

							runTraceData.put("context",
									String.valueOf(Assert_Data.context));

							runTraceData.put("origin",
									String.valueOf(Assert_Data.origin));

							runTraceData.put("priority",
									String.valueOf(Assert_Data.priority));

							runTraceData.put("type",
									String.valueOf(Assert_Data.type));

							runTraceData.put("message",
									String.valueOf(Assert_Data.message));

							runTraceData.put("code",
									String.valueOf(Assert_Data.code));

							runTraceData.put("duration",
									String.valueOf(Assert_Data.duration));

							runTraceData.put("Source_file",
									String.valueOf(Assert_Data.Source_file));

							runTraceData.put("Target_file",
									String.valueOf(Assert_Data.Target_file));

							runTraceData.put("Row_count",
									String.valueOf(Assert_Data.Row_count));

							runTraceData.put("Row_processed",
									String.valueOf(Assert_Data.Row_processed));

							runTraceData.put("Row_rejected",
									String.valueOf(Assert_Data.Row_rejected));

							runTraceData.put("language",
									String.valueOf(Assert_Data.language));

							runTraceData.put("status",
									String.valueOf(Assert_Data.status));

							runTraceData.put("substatus",
									String.valueOf(Assert_Data.substatus));

							runTraceData.put("description",
									String.valueOf(Assert_Data.description));

							runTrace.sendTrace("Assert_Data", "tLogCatcher_1",
									runTraceData);
						}
					...
					if (Assert_Data != null) {
						...
						row9.language = Assert_Data.language;
						row9.status = Assert_Data.status;
						row9.substatus = Assert_Data.substatus;
						row9.description = Assert_Data.description;
	...
	public static void main(String[] args) {
		final Copy_of_Sort_files_2 Copy_of_Sort_files_2Class = new Copy_of_Sort_files_2();

		int exitCode = Copy_of_Sort_files_2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_Sort_files_2.class
					.getClassLoader().getResourceAsStream(
							"local_project/copy_of_sort_files_2_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_Sort_files_2.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Copy_of_Sort_files_2");
		}
...
/************************************************************************************************
 * 557142 characters generated by Talend Open Studio for Data Integration on the
 * May 28, 2019 6:04:48 PM IST
 ************************************************************************************************/
